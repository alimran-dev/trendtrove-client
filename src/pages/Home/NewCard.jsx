    ...
    <div className="relative flex flex-col text-gray-700 bg-white shadow-md w-96 rounded-xl bg-clip-border">
      ...
      <div className="flex justify-around p-6 pt-0">
        <button
          ...
          className="block rounded-lg bg-gradient-to-tr from-pink-700 to-pink-500 mx-auto py-2 px-5 font-sans text-base font-bold uppercase text-white shadow-md shadow-pink-500/20 hover:shadow-lg hover:shadow-pink-500/40 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
        >
          Details
        </button>
      </div>
