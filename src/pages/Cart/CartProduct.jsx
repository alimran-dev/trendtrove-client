...
const CartProduct = ({ cart,handleDelete }) => {
    ...
    return (
        ...
        <div className="p-6 pt-0">
          <button onClick={()=>handleDelete(_id)} className="block mx-auto rounded-lg bg-gradient-to-tr from-pink-700 to-pink-500 py-2 px-5 font-sans text-base font-bold uppercase text-white shadow-md shadow-pink-500/20 hover:shadow-lg hover:shadow-pink-500/40 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none">
            Delete from Cart
          </button>
        </div>
      </div>
